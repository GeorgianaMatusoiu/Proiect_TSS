import Ex1 from "../mutanti/mutant4.js";
import { expect } from "chai";

const myObj = new Ex1();

describe("Testare functionala-mutant4", function () {
...
describe("Testare structurala -mutant4", function () {
    ...
    it("Caz adevarat si caz fals - valid vs invalid -conditie C2 (d<=r)", function () {
        expect(myObj.rezolvare(4, 1, 7)).to.deep.equal([9, 2]);
        expect(myObj.rezolvare(4, 3, 2)).to.deep.equal(["input invalid", null]); // invalid
    });
